...
exports.emailLocalLinkBlock = emailLocalLinkBlock;
...
exports.emailInvitationBody = emailInvitationBody;
exports.emailVerificationBody = emailVerificationBody;
exports.emailPasswordResetBody = emailPasswordResetBody;
...
function emailPrimaryButton(actionUrl, label) {
...
function emailLocalLinkBlock(actionUrl, actionLabel) {
...
function emailExpiryNote(duration) {
    return `
...
function emailInvitationBody(params) {
...
function emailVerificationBody(params) {
...
function emailPasswordResetBody(params) {
