...
let InvitationsRepository = class InvitationsRepository {
    ...
    async findPendingByOrgAndEmail(organizationId, email) {
    ...
    async updateTokenAndExpiry(id, token, expiresAt) {
...
exports.InvitationsRepository = InvitationsRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(organization_invitation_entity_1.OrganizationInvitationEntity)),
