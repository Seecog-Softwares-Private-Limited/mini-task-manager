...
exports.ApiKeysModule = ApiKeysModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([api_key_entity_1.ApiKeyEntity]),
            auth_module_1.AuthModule,
            billing_module_1.BillingModule,
            organizations_module_1.OrganizationsModule,
        ],
        controllers: [api_keys_controller_1.ApiKeysController],
        providers: [api_keys_repository_1.ApiKeysRepository, api_keys_service_1.ApiKeysService],
        exports: [api_keys_service_1.ApiKeysService, api_keys_repository_1.ApiKeysRepository],
    })
], ApiKeysModule);
