...
__decorate([
    (0, typeorm_1.Column)({ name: 'assignee_ids', type: 'simple-json', nullable: true }),
    __metadata("design:type", Object)
], TaskEntity.prototype, "assigneeIds", void 0);
__decorate([
...
exports.TaskEntity = TaskEntity = __decorate([
    ...
    (0, typeorm_1.Index)('idx_tasks_project_created', ['projectId', 'createdAt']),
    (0, typeorm_1.Index)('idx_tasks_org_id', ['organizationId', 'id'])
], TaskEntity);
