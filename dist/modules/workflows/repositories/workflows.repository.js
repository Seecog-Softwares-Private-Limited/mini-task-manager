...
exports.WorkflowsRepository = void 0;
...
let WorkflowsRepository = class WorkflowsRepository {
    constructor(repo) {
        this.repo = repo;
    }
    async findById(id) {
...
exports.WorkflowsRepository = WorkflowsRepository;
exports.WorkflowsRepository = WorkflowsRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(workflow_entity_1.WorkflowEntity)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], WorkflowsRepository);
//# sourceMappingURL=workflows.repository.js.map