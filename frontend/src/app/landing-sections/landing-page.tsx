  ...
  const plans = [
    {
      ...
      features: ["5 team members", "1 project", "5 GB storage", "Kanban boards", "Basic reporting", "Community support"],
    ...
    },
    {
      ...
      features: ["Unlimited users", "Unlimited projects", "100 GB storage", "Custom workflows", "500 automations/mo", "API access", "Advanced reporting", "Time tracking", "Priority email support"],
    ...
    },
    {
      ...
      features: ["Everything in Pro", "Unlimited storage", "Unlimited automations", "SSO (Google, Okta)", "Audit logs", "99.9% SLA", "24/7 dedicated support", "Custom security policies", "Dedicated account manager"],
      cta: "Contact Sales",
      popular: false,
    },
  ];
